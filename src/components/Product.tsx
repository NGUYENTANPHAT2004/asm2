        ...
        <>
            <div className="container">
                ...
                <div className="flex justify-between  ">
                        ...
                        {filterProducts.map((product: Iproduct) => (
                            <div className="relative product_item py-3 px-4 max-w-[300px] max-h-[300px] border-2 border-solid border-[#eee] ">
                                ...
                                <div className="absolute product_act  hidden top-[80px] left-[-28px] translate-x-[50%] item_act flex items-center gap-[13px]">
                                    ...
                                    <div onClick={
                                        () => handlecart((product))}
                                        className=" hover:bg-[#4E7C32] bg-white hover:text-white text-[#4E7C32] w-[40px] h-[34px] cursor-pointer flex items-center justify-center border-2 border-solid border-[#eee]">
                                        <a className="">
                                            <svg
                                                width="19"
                                                height="19"
                    ...
                    {/* Filter Product */}
                    <div className="">
                        <Filter_Product categories={categories} onCategoryChange={handleCategoryChange} />
                    </div>
                </div>
            </div>
        </>
